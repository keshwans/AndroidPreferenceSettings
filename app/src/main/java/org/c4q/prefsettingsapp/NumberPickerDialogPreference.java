 ...
 *
 * @author lukehorvat
 * copied from https://gist.github.com/lukehorvat/4398028
 */

public class NumberPickerDialogPreference extends DialogPreference {
    // if the xml preference did not define default min/max, use these

    private static final int DEFAULT_MIN_VALUE = 12;
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        // when the user selects "OK", pass is thru callChangeListener and if it allows, persist the new value
        if (positiveResult) {
